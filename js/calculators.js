/* Calculator hub — apiebegima.lt (/skaiciuokles/)
   Pulso zonos (Karvonen), treniruočių tempai (Daniels/Gilbert VDOT), laiko prognozė (Riegel). */
(function () {
  if (!document.querySelector('.calc-page')) return;

  /* ── localizable strings ── */
  var T = {
    methodOff: 'procentą nuo maksimalaus pulso',
    methodOn: 'rezervą (Karvoneno metodas, naudojant ramybės pulsą)',
    yourResult: ' · jūsų rezultatas',
    bpm: 'bpm',
    minkm: 'min/km',
    zones: [
      { k: 1, name: 'Atsistatymas',  desc: 'labai lengva',      lo: .50, hi: .60, c: '--z1' },
      { k: 2, name: 'Aerobinė bazė', desc: 'pokalbinis tempas',  lo: .60, hi: .70, c: '--z2' },
      { k: 3, name: 'Aerobinis',     desc: 'pilkoji zona',       lo: .70, hi: .80, c: '--z3' },
      { k: 4, name: 'Slenkstis',     desc: 'tikrai sunku',       lo: .80, hi: .90, c: '--z4' },
      { k: 5, name: 'Maksimumas',    desc: 'intervalai',         lo: .90, hi: 1.00, c: '--z5' }
    ],
    paces: [
      { n: 'Lengvas',    k: 'E', lo: .62, hi: .70, c: '--z2', d: 'aerobinis pagrindas' },
      { n: 'Maratono',   k: 'M', lo: .79, hi: .79, c: '--z3', d: 'tvarus ilgas tempas' },
      { n: 'Slenksčio',  k: 'T', lo: .86, hi: .86, c: '--z3', d: '~20–40 min pastovaus' },
      { n: 'Intervalų',  k: 'I', lo: .97, hi: .97, c: '--z4', d: 'VO₂max stimulas' },
      { n: 'Kartojimų',  k: 'R', lo: 1.04, hi: 1.04, c: '--z5', d: 'greitis, ekonomija' }
    ],
    dists: [
      { n: '5 km', m: 5000 }, { n: '10 km', m: 10000 },
      { n: 'Pusmaratonis', m: 21097.5 }, { n: 'Maratonas', m: 42195 }
    ]
  };
...
function calcInit(T) {
  ...
  /* deep-link: /skaiciuokles/#pace or #pred opens that calculator */
